...
PDF_DATA_DIR = DATA_DIR.joinpath("worddata")
...
def txt_to_pdf(txt_file, pdf_file):
    ...
    # 使用支持Unicode的字体，并指定TTF文件路径
    pdf.add_page()
    pdf.add_font("NotoSansCJK", fname="font/NotoSansTC-Regular.ttf", uni=True)
...
if __name__ == "__main__":
    # txt_file = './worddata/questions.txt'  # 输入的TXT文件
    # pdf_file = './worddata/questions.pdf'  # 转换后的PDF文件
    # 检查文件是否存在，避免重复转换
    # 如果要将文件夹中的所有Word文件转换为PDF
    convert("./worddata")
